...
// Reviews Routes
router.post('/', isLoggedIn, isValidSchema(reviewSchema), handleAsyncErr(async (req, res) => {
...
router.delete('/:reviewId', isLoggedIn, isAuthor(Review), handleAsyncErr(async(req, res) => {
