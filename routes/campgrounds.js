...
router.get('/:id/edit', isLoggedIn, handleAsyncErr(async (req, res) => {
...
router.put('/:id', isLoggedIn, validateSchema(campgroundSchema), handleAsyncErr(async (req, res) => {
    const { id } = req.params;
...
router.delete('/:id', isLoggedIn, handleAsyncErr(async (req, res) => {
    const { id } = req.params;
