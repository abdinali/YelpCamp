...
router.post('/', isLoggedIn, validateSchema(campgroundSchema), handleAsyncErr(async (req, res) => {
...
router.get('/:id/edit', isLoggedIn, isAuthor, handleAsyncErr(async (req, res) => {
...
router.put('/:id', isLoggedIn, isAuthor, validateSchema(campgroundSchema), handleAsyncErr(async (req, res) => {
    const { id } = req.params;
...
router.delete('/:id', isLoggedIn, isAuthor, handleAsyncErr(async (req, res) => {
    const { id } = req.params;
